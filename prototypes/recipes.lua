...
----NEW Fluids
	{
		...
		icon = "__SeaTorio__/graphics/chemical-waste-water.png",
		icon_size = 64,
		icon_mipmaps = 4,
	...
	
	{
		...
		icon = "__SeaTorio__/graphics/mineral-mix.png",
		icon_size = 64,
		icon_mipmaps = 4,
		order = "a[mineral-mix]",
		subgroup = "seatorio-inter",
	...
	
	{
		...
		icon = "__SeaTorio__/graphics/dissolver.png",
		icon_size = 64,
		icon_mipmaps = 4,
		order = "a[dissolver]",
		subgroup = "seatorio-inter",
	...
	
	{
		...
		icon = "__SeaTorio__/graphics/sand-from-water.png",
		icon_size = 64,
...

	{
		...
		icon = "__SeaTorio__/graphics/advanced-oil-processing.png",
		icon_size = 64,
		category = "oil-processing",
...
---------MINERAL MIX
	{
		...
		icon = "__SeaTorio__/graphics/stone-brick-mineral-mix.png",
		icon_size = 64,
		category = "chemistry",
		order = "a[mineral-mix]",
	...
	------------------EXTRACTION
	{
		...
		icon = "__SeaTorio__/graphics/basic-extraction.png",
		icon_size = 64,
		category = "chemistry",
		order = "d[mineral-mix]",
		subgroup = "seatorio-extraction"
...
-----Clean chemical waste
	{
		...
		icon = "__SeaTorio__/graphics/clean-chemical-waste-water.png",
		icon_size = 64,
		category = "growing",
